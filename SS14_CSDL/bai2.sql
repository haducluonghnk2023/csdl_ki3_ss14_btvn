...
-- 3 Trigger tự động thêm lương khi nhân viên mới được thêm
DELIMITER //
...
-- 4 Trigger lưu lịch sử lương khi nhân viên bị xóa
DELIMITER //
...
-- 5 Trigger tự động cập nhật total_hours khi nhân viên checkout
DELIMITER //
